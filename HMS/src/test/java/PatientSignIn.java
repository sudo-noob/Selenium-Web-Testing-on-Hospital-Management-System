...
public class PatientSignIn extends HMS {
    ...
    public void TC_WB_PS1_clicksubmit() throws InterruptedException
    {
        ...
        submit.click();
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/registration.php";//Enter the link of the web page to which login page will direct us.
