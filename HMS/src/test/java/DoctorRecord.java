...
public class DoctorRecord extends HMS
{
    @Test
    public void TC_WB_AD_doctorrecord() throws InterruptedException
    {
        ...
        login.click();
        Thread.sleep(2000);
        WebElement totalDoctor = driver.findElement(By.xpath("/html/body/div/div[2]/div/div/div/div/div[2]/div/div/p/a"));
        totalDoctor.click();
        Thread.sleep(2000);
