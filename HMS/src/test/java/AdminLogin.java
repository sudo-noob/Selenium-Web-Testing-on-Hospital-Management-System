...
public class AdminLogin extends HMS{
    ...
    public void TC_WB_AL2_firstwronglogin() throws InterruptedException
    {
        ...
        login.click();
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/admin/index.php";//Enter the link of the web page to which login page will direct us.
        String expectedUrl= driver.getCurrentUrl();
        Assert.assertEquals(expectedUrl,actualUrl);
        System.out.println("------------------------------------------------------------------");
    }
