...
public class PatientPasswordChange extends HMS {
    ...
    public void TC_WB_CP1_changepassword() throws InterruptedException
    {
        ...
        submit.click();
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/change-password.php";//Enter the link of the web page to which login page will direct us.
