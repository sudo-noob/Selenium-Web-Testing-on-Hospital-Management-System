...
public class BookAppointment extends HMS{
    ...
    public void TC_WB_BA1_bookingappointment() throws InterruptedException{
        ...
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/book-appointment.php";//Enter the link of the web page to which login page will direct us.
