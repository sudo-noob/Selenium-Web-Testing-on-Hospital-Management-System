...
public class PatientSidebarMenu extends HMS{
    @Test
    public void TC_WB_SM1_dashboard() throws InterruptedException{
        ...
        logout.click();
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/index.html";
    ...
    public void TC_WB_SM3_bookmyappointment()throws InterruptedException{
        ...
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/appointment-history.php";
        String expectedUrl= driver.getCurrentUrl();
        Assert.assertEquals(expectedUrl,actualUrl);
        System.out.println("------------------------------------------------------------------");
    }
