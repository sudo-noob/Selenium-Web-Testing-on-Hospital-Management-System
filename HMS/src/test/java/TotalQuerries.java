...
public class TotalQuerries extends HMS
{
    @Test
    public void TC_WB_AQ_doctorquerries() throws InterruptedException
    {
        ...
        login.click();
        Thread.sleep(2000);
        WebElement totalquerries = driver.findElement(By.xpath("/html/body/div/div[2]/div/div/div/div/div[4]/div/div/p/a[2]"));
        totalquerries.click();
        Thread.sleep(2000);
        String actualUrl="http://localhost/Hospital%20Management%20System/hospital/hms/admin/unread-queries.php";//Enter the link of the web page to which login page will direct us.
